...
(6, 'ntdat0103@gmail.com', '234', 'Nguyễn Tiến Đạt', '', 'abcefc0937332aa06070bf98004a7b59', 1);
...
--
ALTER TABLE `oder`
  MODIFY `oder_id` int(10) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `address`
  ...
  ADD CONSTRAINT `address2` FOREIGN KEY (`oder_id`) REFERENCES `oder` (`oder_id`) ON DELETE CASCADE ON UPDATE CASCADE;
